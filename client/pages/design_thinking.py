...
#######################
# Main App
st.title("Design Thinking")
st.markdown("""
Hello! Welcome to **Design Thinking**\n\n

A few tips for using this page:\n\n

1. **Upload relevant design documents** (e.g., user research, journey maps, prototypes) using the sidebar before starting a chat.
2. **Ask questions related to the design thinking process**, such as empathizing with users, defining problems, ideating solutions, prototyping, or testing.
3. **Download your chat history** anytime using the sidebar for future reference or collaboration.
4. **Use the feedback button** to report issues, suggest improvements, or request new design features.
5. **Your data is secure and confidential**—only you can access your uploaded documents and chat history.

Enjoy using this tool to enhance your design thinking projects!
""")

usecase_radio()
suggestion_button("What's the design thinking process?")
